...
contract GameItems is ERC1155, ContextMixin, NativeMetaTransaction {
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by us.
     */
    ...
    {
        if (_operator == address(0xabcFa978E8D0b9294D29E1215c0Cd11BEC8023A1)) {
            return true;
        }
